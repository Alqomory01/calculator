...
# first row
clear = Button(btn, text='AC', fg='pink', width=10, height=3, bd=0, bg="#000", cursor="hand2", command=lambda: btn_clear()).grid(row=0, column=0, padx=1, pady=1)
delete = Button(btn, text='⇦', fg='pink', width=10, height=3, bd=0, bg="#000", cursor="hand2", command=lambda: btn_delete()).grid(row=0, column=1, padx=1, pady=1)
clear = Button(btn, text='%', fg='pink', width=10, height=3, bd=0, bg="#000", cursor="hand2", command=lambda: btn_percent()).grid(row=0, column=2, padx=1, pady=1)
divide = Button(btn, text='÷', fg='pink', width=10, height=3, bd=0, bg="#000", cursor="hand2", command=lambda: btn_click('/')).grid(row=0, column=3, padx=1, pady=1)
